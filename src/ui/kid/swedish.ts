...
export const KID_STEPS: Record<string, KidStep> = {
  ...
  'control-lock': {
    icon: '🔓',
    title: 'Ta bort rattlåset',
    action: 'Dra ut den röda pinnen ur ratten. Håll in musknappen och dra neråt.',
    why: 'Pinnen håller ratten stilla när planet står ute i blåsten. Nu ska ratten kunna röra sig igen.',
  },
  'brakes-set': {
    icon: '🅿️',
